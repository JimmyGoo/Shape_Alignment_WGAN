...
def build_graph(real_cp):
	...
	fake_cp, g_params = generator(BATCH_SIZE, output_shape, gen_filter_shape, Z_SIZE)

	true_logit, d_params = discriminator(real_cp, BATCH_SIZE, dis_filter_shape, output_shape['g4'])
	fake_logit, _ = discriminator(fake_cp, BATCH_SIZE, dis_filter_shape, output_shape['g4'], reuse=True)
...
def main():
	...
	fake_cp, _ = generator(BATCH_SIZE, output_shape, gen_filter_shape, Z_SIZE, reuse=True, is_training=False)
